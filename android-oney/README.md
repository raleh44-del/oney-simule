...
Enveloppe Android (WebView) autour du simulateur `docs/oney/index.html`.
...
Le build tourne automatiquement a chaque modification de `docs/oney/index.html`
ou de `android-oney/`. L'APK est publie ici :
